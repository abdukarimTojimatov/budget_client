...
const LoanCards = ({
  ...
  const hasNoLoans =
    !loading &&
    (!data?.getLoans?.docs || data?.getLoans?.docs.length === 0);
        ...
        <div className="">
          ...
          {data?.getLoans?.docs && data?.getLoans?.docs.length > 0 && (
            <div className="mt-8 flex justify-center">
              <Pagination
                currentPage={page}
                totalPages={data?.getLoans?.totalPages || 1}
                hasPrevPage={data?.getLoans?.hasPrevPage}
                hasNextPage={data?.getLoans?.hasNextPage}

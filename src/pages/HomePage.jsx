  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div
        ...
        } bg-gray-800/50 p-4 rounded-xl shadow-lg border border-gray-700/30 mb-6 overflow-hidden transition-all duration-300 ease-in-out`}
      >
      ...
      {/* Cards component with filtered props */}
      <Cards 
